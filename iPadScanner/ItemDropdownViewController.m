...
{
    [super viewDidLoad];
    self.contentSizeForViewInPopover = CGSizeMake(180, 170);
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (textField.text.length)  {
        NSUInteger index = [self.source indexOfObject:textField.text];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    textField.text = [source objectAtIndex:indexPath.row];
    [delegate itemSelected:[source objectAtIndex:indexPath.row]];
